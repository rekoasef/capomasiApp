...
**Sesión 2026-09-10:** se arregló el comparativo entre períodos, que era el único reporte que seguía sin mirar la facturación migrada (Paola: _"lo histórico no me lo compara"_). Buscando eso apareció que **las 16 vistas eran legibles con la anon key sin loguearse** — migración 0079, escrita y **sin aplicar**. Antes de tocar nada, leer `docs/core/PENDIENTES.md`.
